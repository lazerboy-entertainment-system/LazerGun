...
void loop() 
{
  ...
  // ON TRIGGER DEBOUNCE TIMER EVENT
    ...
    // ELSE
      // IF FIRING MODE IS THREE ROUND BURST
        // FOR SHOT 1 TO 3
          // IF MAGAZINE CAPACITY NOT EMPTY
            // FIRE LASER
            // GENERATE FIRE LASER SOUND
            // DELAY FOR LASER PULSE DURATION
            // STOP FIRING LASER
            // DELAY FOR REPEATING SOUND DURATION
            // STOP FIRE LASER SOUND
            // DELAY FOR REPEATING RESET DURATION
            // DECREMENT MAGAZINE CAPACITY
      // ELSE IF FIRING MODE IS FULLY AUTOMATIC
  ...
  {  
    ...
    else
    {
      ...
      else if (firingMode >= MODE_FULLY_AUTOMATIC)
      {
